...
func Page(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<!doctype html><html><head><link rel=\"icon\" href=\"/public/favicon.ico\" type=\"image/x-icon\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>")
		if templ_7745c5c3_Err != nil {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/common/page.templ`, Line: 20, Col: 17}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var2))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title><script src=\"/public/htmx.min.js\"></script><link href=\"/public/tailwind.css\" rel=\"stylesheet\"><script src=\"https://unpkg.com/lucide@0.488.0\"></script><style>\n\t\t\t\t.htmx-indicator:not(.htmx-request) {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t</style></head><body class=\"h-full\"><div class=\"navbar shadow-sm sticky top-0 z-50 bg-base-100 h-16\"><div class=\"flex justify-between md:justify-start w-full items-center px-4\"><div class=\"flex-none md:hidden\"><button class=\"btn btn-square btn-ghost\" onclick=\"toggleSidebar()\"><i data-lucide=\"menu\"></i></button></div><div class=\"flex-1 flex justify-center md:justify-start\"><a href=\"/\" class=\"flex gap-4 flex-row items-center font-sans\"><img class=\"h-8 md:h-8\" src=\"/public/logo.png\"> <span class=\"text-2xl font-bold text-[#005f6e]\">Groundwork</span></a></div></div></div><div id=\"sidebar-backdrop\" class=\"fixed inset-0 bg-black opacity-20 z-40 hidden md:hidden\" onclick=\"toggleSidebar()\"></div><div class=\"flex\"><div id=\"sidebar\" class=\"fixed md:sticky top-16 h-[calc(100dvh-64px)] bg-base-100 w-80 shadow-md overflow-y-auto z-40 -left-80 md:left-0 transition-all duration-300\"><ul class=\"menu p-4 w-full\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, entry := range sidebar_entries {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<li class=\"[&amp;.active]:font-bold [&amp;.active]:bg-base-300\"><a href=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" class=\"flex gap-8 text-2xl w-full\"><i data-lucide=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/common/page.templ`, Line: 53, Col: 36}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/common/page.templ`, Line: 54, Col: 21}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</ul></div><main class=\"flex-1 h-[calc(100dvh-64px)] overflow-y-auto p-8 w-full\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
